...
- البرنامج يعمل أونلاين فقط من خلال الرابط الرسمي: `https://pandystore.github.io/size/`.
- عند فتح ملف `index.html` مباشرة من الجهاز، يمنع البرنامج التشغيل ويعرض زرًا لفتح الرابط الرسمي.
- لا يستخدم البرنامج localStorage لحفظ بيانات الأصناف أو الإعدادات.
- جلسة تسجيل الدخول مدتها القصوى 10 ساعات، وتنتهي أيضًا عند إغلاق جلسة المتصفح.
- عند انتهاء الجلسة أو تسجيل الخروج ينظف البرنامج بيانات جلسة الدخول وCache Storage تلقائيًا، ثم يطلب تسجيل الدخول من جديد.
- تنظيف الكاش أو تسجيل الخروج لا يحذف الأصناف أو الإعدادات من Realtime Database؛ حذف البيانات يتم يدويًا فقط من داخل البرنامج.
